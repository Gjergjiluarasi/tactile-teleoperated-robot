...
void PrintSettings(long a_nodeID, std::string a_deviceName, std::string a_protocolStackName, std::string a_interfaceName, std::string a_portName, int a_baudrate)
{
	std::stringstream msg;

	msg << "default settings:" << std::endl;
	msg << "node id             = " << a_nodeID << std::endl;
	msg << "device name         = '" << a_deviceName << "'" << std::endl;
	msg << "protocal stack name = '" << a_protocolStackName << "'" << std::endl;
	msg << "interface name      = '" << a_interfaceName << "'" << std::endl;
	msg << "port name           = '" << a_portName << "'"<< std::endl;
	msg << "baudrate            = " << a_baudrate;
