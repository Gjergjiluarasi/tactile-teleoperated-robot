...
void rcmFK(std::array<double, 7> q, double eta, Matrix4d &XX, Matrix4d &XXp, Matrix<double, 3, 8> &JJe,
           Matrix<double, 3, 8> &JJp)  // Vector7d q
{
    Matrix4d Ab0, A01, A12, A23, A34, A45, A56, A67, A7f, Afr, Arp, Ape, Afr1, Afr2, Afr3;
    Matrix4d Ab1, Ab2, Ab3, Ab4, Ab5, Ab6, Ab7, Abf, Abp, Abe;
    Matrix3d R1, R2, R3, R4, R5, R6, R7;
    Matrix<double, 6, 8> Je, Jp;
