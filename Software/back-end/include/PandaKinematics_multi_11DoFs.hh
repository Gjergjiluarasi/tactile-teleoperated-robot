...
void rcmFK(std::array<double, 7> q, double eta, Matrix4d &XX, Matrix4d &XXp, Matrix<double, 6, 11> &JJe6, Matrix<double, 3, 11> &JJp3,std::array<double, 3> q_maxon  ); // Vector7d q