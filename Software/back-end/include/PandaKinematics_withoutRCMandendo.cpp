...
void rcmFK(std::array<double, 7> q,Matrix4d &XX,Matrix<double, 6, 7> &JJe6) // Vector7d q
{
    ...
    Matrix<double, 6, 7> Je, Jp;     
    Matrix<double, 3, 7> Je3, Jp_new; 
...
// Apef.setIdentity();
    ...
    Je << z1.cross(pp - p1), z2.cross(pp - p2), z3.cross(pp - p3), z4.cross(pp - p4), z5.cross(pp - p5), z6.cross(pp - p6), z7.cross(pp - p7),
